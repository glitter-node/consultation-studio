...
class UserTemplateComposer
{
    ...
    public function compose(View $view): void
    {
        ...
        [$templateCssAssets, $templateJsAssets] = $this->resolveTemplateAssetUrls($activeTemplate);
        ...
        $view->with('templateCssAssets', $templateCssAssets);
        $view->with('templateJsAssets', $templateJsAssets);
        $view->with('pluginAssets', $pluginAssets);
        $view->with('appConfig', $appConfig);
    }

    private function resolveTemplateAssetUrls(?string $identifier): array
    {
        if (empty($identifier)) {
            return [[], []];
        }

        $templateJsonPath = base_path("templates/{$identifier}/template.json");
