...
use App\Http\Controllers\Api\Public\ConsultationReservationCompatController;
...
Route::group([], function () {
    ...
    Route::prefix('modules')->group(function () {
        Route::get('consultation-reservation/reserve-context', [ConsultationReservationCompatController::class, 'reserveContext'])
            ->name('api.public.modules.consultation-reservation.reserve-context');
...
Route::prefix('auth')->group(function () {
    ...
    // 비회원도 current_user 조회 가능 (로그인 시 사용자 정보, 비로그인 시 null 반환)
    Route::middleware(['optional.sanctum', 'check.user_status'])->group(function () {
