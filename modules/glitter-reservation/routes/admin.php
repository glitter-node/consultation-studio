...
/*
|--------------------------------------------------------------------------
| Reservation Admin API Routes
|--------------------------------------------------------------------------
|
| ModuleRouteServiceProvider가 다음 prefix/name prefix를 자동 적용합니다.
| - URL prefix: api/modules/glitter-reservation
| - Name prefix: api.modules.reservation.
|
*/
